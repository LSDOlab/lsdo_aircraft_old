...
class SimpleMotor(OptionsDictionary):
    ...
    def initialize(self):
        ...
        self.declare('line_current_density', default=8.5 * 10 ** 4, types=float_types)
        self.declare('number_of_poles_per_phase', default=6., types=float_types)
        self.declare('hysteresis_coeff', default=1., types=float_types)
        self.declare('copper_resistivity', default=1.68 * 10 ** -8, types=float_types)
